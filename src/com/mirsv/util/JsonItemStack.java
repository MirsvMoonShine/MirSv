...
public class JsonItemStack {
    ...
    public static String toJson(ItemStack[] contents) {
        JsonArray array = new JsonArray();
        for (ItemStack stack : contents) {
            array.add(toJson(stack));
        }
        return gson.toJson(array);
    }

    public static List<ItemStack> fromJson(JsonArray array) {
        List<ItemStack> contents = new ArrayList<>();
        for (JsonElement element : array) {
            if (element instanceof JsonObject) {
                contents.add(fromJson((JsonObject) element));
    ...
    public static JsonElement toJson(ItemStack itemStack) {
        ...
        if (itemStack == null || itemStack.getType() == Material.AIR) return JsonNull.INSTANCE;
    ...
    public static ItemStack fromJson(JsonObject json) {
        ...
        if (typeElement.isJsonPrimitive()) {
            ...
            JsonElement itemMetaElement = json.get("item-meta");
